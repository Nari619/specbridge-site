...
- Classify FUNCTIONAL status only — ignore compliance posture (compliance is decided separately, in code):
  - "covered": a candidate fully supports the capability.
  - "partial": a candidate covers some of it, or a deprecated candidate is the only functional match.
  - "missing": none of the candidates support it (matched_tool = null).
